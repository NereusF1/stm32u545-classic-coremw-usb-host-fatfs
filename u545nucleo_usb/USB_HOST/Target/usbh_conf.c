...
extern HCD_HandleTypeDef hhcd_USB_DRD_FS;//nff -> defined by CUBEMX in main.c
...
//  //if(hcdHandle->Instance==USB_OTG_FS) //>>USB_DRD_FS
//  if(hcdHandle->Instance==USB_DRD_FS) //nff
//  {
...
//    GPIO_InitStruct.Pin = USB_DM_Pin|USB_DP_Pin;  //nff
//    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
//    GPIO_InitStruct.Pull = GPIO_NOPULL;
//    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
//    //GPIO_InitStruct.Alternate = GPIO_AF10_OTG_FS; //GPIO_AF10_USB_HS same as USB_OTG_HS
//    GPIO_InitStruct.Alternate = USB_DRD_FS; //nff
...
////    HAL_NVIC_SetPriority(OTG_FS_IRQn, 0, 0); //USB_IRQn
////    HAL_NVIC_EnableIRQ(OTG_FS_IRQn); //USB_IRQn
//    HAL_NVIC_SetPriority(USB_IRQn, 0, 0); //nff
//    HAL_NVIC_EnableIRQ(USB_IRQn); //nff
...
////                          |USB_DP_Pin);
//
//    HAL_GPIO_DeInit(GPIOA, USB_DM_Pin|USB_DP_Pin);  //nff
//
//    /* Peripheral interrupt Deinit*/
//    //HAL_NVIC_DisableIRQ(OTG_FS_IRQn); //USB_IRQn
//    HAL_NVIC_DisableIRQ(USB_IRQn); //nff
//
